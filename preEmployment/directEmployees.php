...
<div id="dropdownDots<?php echo $queNo;?>" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
    ...
    <li>
        <a type="button" onclick="openEditEmployee()" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
      </li>
      <li>
...
const modalEdit = new Modal(editEmployee, editemployees, instanceeditemployee);
