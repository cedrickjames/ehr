...
header("Content-Disposition: attachment; filename=Failed_Data_from_Importing_Employees_Record.csv");
header("Expires: 0");
...
// Add CSV headers
fputcsv($output, [
    'ID Number', 'Name', 'Email', 'Birthday', 'Age', 'Sex', 'Address', 
    'Civil Status', 'Employer', 'Building', 'Value', 'Section', 'Position', 'Date Hired'
]);
