    ...
    foreach ($data as $row) {
        if ($count > 0) {
            ...
            if (!isidNumberExists($con, $idNumber, $employer)) {
                ...
                $errorLogs[] = "$idNumber, ";
                array_push($failedData, [$dateReceived, $datePerformed, $idNumber, $IMC, $OEH, $PE, $CBC, $U_A, $FA, $CXR, $VA, $DEN, $DT, $PT, $otherTest, $followUpStatus, $status, $attendee, $confirmationDate, $FMC]); 
