...
header("Content-Disposition: attachment; filename=Failed_Data_from_Importing_APE.csv");
header("Expires: 0");
...
fputcsv($output, [
    'Date Received', 'Date Performed', 'Id Number', 'IMC', 'PE', 'CBC', 'U/A', 'FA', 'CXR', 'VA', 'DEN', 'DT', 'PT', 'Other Test', 'Follow Up Status', 'Status', 'Attendee', 'Compliance Date', 'FMC'
]);
