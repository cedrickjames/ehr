            ...
            <section class="mt-2 2xl:mt-10">
                ...
                <thead>
                    ...
                    LEFT JOIN
                        users
                    ON
                        consultation.nurseAssisting = users.idNumber WHERE consultation.statusComplete = '0' ORDER BY
    consultation.id ASC; 
                    ";
