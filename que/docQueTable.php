...
<p class="mb-2"><span class=" self-center text-md font-semibold whitespace-nowrap   text-[#193F9F]">On Queue</span></p>
        ...
        <div class=" p-4 rounded-lg  bg-gray-50 " id="headApproval" role="tabpanel"
            ...
            <section class="mt-2 2xl:mt-10">
                <table id="docQueTable" class="display text-[9px] 2xl:text-sm" style="width:100%">
                <thead>
                        <tr>
                            <th >No.</th>
                            <th >Name</th>
                    ...
                    LEFT JOIN
                        users
                    ON
                        consultation.nurseAssisting = users.idNumber WHERE consultation.status = 'doc' ORDER BY
    consultation.id ASC; 
                    ";
