              ...
              ?> <tr style="background-color: <?php if ($row['status'] == 'processing') {
                  ...
                  <td>
                    <div class="content-center flex flex-wrap justify-center gap-2">
                      ...
                      <a type="button" href="../nurses/fromDoctorsConsultation.php?rf=<?php echo $row['idNumber']; ?>&dcnsltn=<?php echo $row['id']; ?>" class="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 rounded-full px-3 py-2  text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">View</a>
                      <?php
