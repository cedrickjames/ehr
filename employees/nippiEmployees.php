                ...
                <section class="mt-2 2xl:mt-10">
                    <table id="queTable" class="display text-[9px] 2xl:text-sm" style="width:100%">
                        ...
                        <tbody>
                            <?php
                            $queNo = 1;
                            $sql = "SELECT * FROM `employeespersonalinfo` WHERE `employer` = 'Nippi' ORDER BY `Name` ASC; 
                    ";
            ...
            <form method="POST" class="px-4 md:px-5 py-2 text-[8pt]">
                <div class="grid gap-2 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <input type="text" name="employer" value="Nippi" id="employer" class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full px-2.5 py-1.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                    </div>
                    <div class="col-span-2 sm:col-span-1">
            ...
            <form method="POST" class="px-4 md:px-5 py-2 text-[8pt]">
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <input type="text" name="editemployer" id="editemployer" value="Nippi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="" readonly>
                    </div>
                    <div class="col-span-2 sm:col-span-1">
...
<script>
    ...
    function exportTemplate() {
        ...
        link.setAttribute("download", "Nippi Employees Template.csv");
