            ...
            <section class="mt-2 2xl:mt-10">
                <table id="medicalRecordTable" class="display h-10" style="width:100%">
                    ...
                    <tbody>
                        <?php
                        $ftwNo = 1;
                        $sql = "SELECT pmh.*, e.Name, e.employer, e.department FROM `pastmedicalhistory` pmh LEFT JOIN `employeespersonalinfo` e ON e.idNumber = pmh.idNumber  where e.Name != '' ORDER BY `id` ASC";
