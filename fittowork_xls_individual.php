...
header("Content-Disposition: attachment; filename=Fit to work Report for " . $employeeid . ".xls");  //File name extension was wrong
header("Expires: 0");
...
LEFT JOIN `employeespersonalinfo` e ON e.idNumber = f.idNumber WHERE f.idNumber = '$employeeid' ORDER BY `id` ASC");
...
<body>
    <center>
        ...
        <br>
        <h3> <b> "Fit to work" for <?php echo $employeeid ?></b></h3>
