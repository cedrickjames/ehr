    ...
    z-index: 100000;">
      ...
      <div class=" pt-20 px-28 2xl:pt-40 2xl:px-40 w-full md:w-8/12 lg:w-6/12 mb-12 md:mb-0">
        ...
        <form method="post" action="signup.php">
          ...
          <!-- Id Number -->
          <div class="mb-4">
            <input type="text" name="idnumber" autocomplete="off" class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Employee Number" />
          </div>
          <!-- Name -->
          <div class="mb-4">
            <input type="text" name="name" autocomplete="off" class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Name" />
          </div>
          <!-- Email -->
          <div class="mb-4">
            <input type="text" name="email" autocomplete="off" class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Email" />
          </div>
          <!-- User Type -->
          <div class="mb-4">
