...
<body class="h-screen bg-no-repeat bg-cover bg-[url('../src/Background.png')]">
  ...
  <div  id="content" style="display: none; background: linear-gradient(-45deg, #05458cba, rgba(255, 255, 255, 0.63), rgba(255, 255, 255, 0));" class="h-full ml-56 2xl:ml-[22rem] flex   left-10 right-5  flex-col  px-2   pt-2 2xl:pt-6 pb-14 z-50 ">
